import type { Country, Hotel, BoardType, CountryMeals } from '../types/booking';
...
export const meals: Record<string, CountryMeals> = {
  Turkey: {
    dinner: [
...
export const citizenshipMultipliers: Record<string, number> = {
  "Turkey": 1.0,
  "UAE": 1.25,
  "Italy": 1.15
};